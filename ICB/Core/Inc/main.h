...
#define nCs2_Pin GPIO_PIN_13
#define nCs2_GPIO_Port GPIOB
#define LED_Pin GPIO_PIN_8
#define LED_GPIO_Port GPIOA
#define DN2_Pin GPIO_PIN_4
#define DN2_GPIO_Port GPIOB
#define UP2_Pin GPIO_PIN_5
#define UP2_GPIO_Port GPIOB
#define DN1_Pin GPIO_PIN_6
#define DN1_GPIO_Port GPIOB
#define UP1_Pin GPIO_PIN_7
#define UP1_GPIO_Port GPIOB
